...
X_train,X_test,Y_train,Y_test = np.load(
    'C:/Users/PC/work/python/AI_intel_S2/datasets/bi_image_data.npy',
    allow_pickle=True)
...
early_stopping = EarlyStopping(monitor='val_binary_accuracy',   #monitor는 감시대상
                               patience=10)                      #7epochs가 떨어지면 실행
...
model.save('./horse_or_human_{}.h5'.format(str(np.around(score[1],3))))
