...
# img = dlib.load_rgb_image('./models/imgs/04.jpg')
...
#         #x, y, w, h = x *1.2, y *1.2, w *1.2, h *1.2
...
# test_img = dlib.load_rgb_image('./models/imgs/02.jpg')
...
img1 = dlib.load_rgb_image('./models/imgs/08.jpg')
img1_faces = align_faces(img1)

img2 = dlib.load_rgb_image('./models/imgs/makeup/XMY-136.png')
